...
* Gerenciador de sistema do SANtricity -- uma interface baseada na Web usada para gerenciar uma controladora em um storage array.
* Gerenciador Unificado do SANtricity -- uma interface baseada na Web usada para visualizar e gerenciar todos os storage arrays em sua rede.
